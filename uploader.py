...
import configparser #lowercase for python3
...
class MotionUploader:
   ...
   #     server.quit()    
    ...
    def upload_video(self, video_file_path): #pdq added video_link return
        ...
        media = MediaFileUpload(video_file_path, mimetype='application/octet-stream')
